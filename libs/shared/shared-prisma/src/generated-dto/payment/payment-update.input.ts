...
import { UserUpdateOneRequiredWithoutPaymentNestedInput } from '../user/user-update-one-required-without-payment-nested.input';
...
export class PaymentUpdateInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutPaymentNestedInput, {nullable:true})
